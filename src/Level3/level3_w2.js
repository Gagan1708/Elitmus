var questions = [
    {
        "question": 'Which is the most abundant mineral found in the Earth\'s continental crust ?',
        "options" : {
            "o1": "Rhinestone (Quartz) ",
            "o2": "Feldspar ",
            "o3": "asbestos (mica) ",
        }
    },
    {
        "question": 'Jadugra, in Singhbhum district, Jharkhand is an important mine for which of the following ?',
        "options" : {
            "o1": "Uranium",
            "o2": "Manganese ",
            "o3": "Emerald ",
    ...
    {
        "question": 'Which of the following states has one of the richest monazite deposits in India ?',
        "options" : {
            "o1": "Kerala ",
            "o2": "Gujarat ",
            "o3": "Rajasthan ",
