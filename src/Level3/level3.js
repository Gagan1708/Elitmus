var questions = [
    {
        "question": 'Computer and communication technology, such as communication links to the Internet, that provide help and understanding to the end user is known as ?',
        "options" : {
            "o1": "presentation file ",
            "o2": "information technology ",
            "o3": "program ",
        }
    },
    {
        "question": 'The time for the actual data transfer after receiving the request for data from secondary storage is referred to as the disk’s ?',
        "options" : {
            "o1": "transfer time ",
            "o2": "movement time",
            "o3": "access time",
    ...
    {
        "question": 'A program, either talk or music, that is made available in digital format tor automatic download over the Internet is called a __________ ?',
        "options" : {
            "o1": "wiki ",
            "o2": "podcast ",
            "o3": "vodcast ",
